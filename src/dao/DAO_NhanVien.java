...
public class DAO_NhanVien {
	...
	public int getNgayDiTre(String manv, int month) {
		String sql = "select songayditre=count(trangthai) from chitietcalam where manv='" + manv
				+ "' and trangthai='Tre gio' and MONTH(ngaylam)='" + month + "'";
		Connection conn = ConnectDatabase.getConnection();
		int ngaydilamtre = 0;
		try {
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public int getNgayDungGio(String manv, int month) {
		String sql = "select songaydunggio=count(trangthai) from chitietcalam where manv='" + manv
				+ "' and trangthai='Dung gio' and MONTH(ngaylam)='" + month + "'";
		Connection conn = ConnectDatabase.getConnection();
		int ngaydidunggio = 0;
		try {
			PreparedStatement ps = conn.prepareStatement(sql);
